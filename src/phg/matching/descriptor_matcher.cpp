     ...
     for (int i = 0; i < matches.size(); ++i) {
         ...
         for (int j = 0; j < total_neighbours; ++j) {
             if (distances2_query.at<float>(i, j) < radius2_query) {
                 for (int g = 0; g < total_neighbours; ++g) {
                     if (distances2_train.at<float>(i, g) < radius2_train) {
                         if (indices_query.at<int>(i, j) == indices_train.at<int>(i, g)) {
                             ++cnt_same;
                         }
                     }
                 }
         ...
         if (cnt_same >= consistent_matches) {
